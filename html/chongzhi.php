...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="putong_index.php">首页</a> <a href="chongzhi.php" class="cur">账户充值</a></div>
	</div>
	...
	<div class="main_s">
		...
		<div class="IF1 clearfix" style="padding:70px 0% 0 5%;width:57%;">
			...
			<div class="IF3" style="margin-top:20px;">
				<p>&nbsp;</p>
				<input type="submit" name="button" id="button" value="立即充值" class="sub5" style="margin-left:0px;"/>
			</div>
		</div>
