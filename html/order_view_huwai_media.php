...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="putong_index.php">首页</a><a href="order_list.php">订单管理 </a><a href="order_view_huwai_media.php" class="cur">订单详情 </a></div>
	</div>
	...
	<div class="main_o">
		...
		<div class="clearfix wrap_f" style="padding-bottom:50px;width: 60%;">
			...
			<form action="" method="post">
				...
				<div class="item_f"><p><i class="LGntas"></i>活动名称：</p>
					<div class="r"><input type="text" name="textfield" id="textfield" class="txt_f1" style="width:60%;"></div>
				</div>
				...
				<div class="item_f txt_table"><p><i class="LGntas"></i>投放基数：</p>
					<div class="r">
						<ul>
							<li><span class="sp1">投放形式：</span><input type="text" name="textfield" id="textfield" class="toufangjishu" /></li>
							<li><span class="sp1">广告商圈：</span><input type="text" name="textfield" id="textfield" class="toufangjishu" /></li>
							<li><span class="sp1">投放周期：</span><input type="text" name="textfield" id="textfield" class="toufangjishu" /></li>
							<li><span class="sp1">投放面积：</span><input type="text" name="textfield" id="textfield" class="toufangjishu" /></li>
							<li><span class="sp1">投放位置：</span><input type="text" name="textfield" id="textfield" class="toufangjishu" /></li>
						</ul>
					</div>
				</div>

				<div class="item_f"><p><i class="LGntas"></i>订单内容：</p>
					<div class="r">
						<textarea class="txt_ft1" style="height:230px;"></textarea>
					</div>
				</div>
				<div class="item_f"><p><i class="LGntas"></i>平台价：</p>
					<div class="r"><input type="text" name="textfield" id="textfield" class="txt_f1" style="width:16%;" /><span class="color1" style="color:#ff0000; font-size:20px; margin-left:10px;">元</span></div>
				</div>
				<div class="item_f"><p><i class="LGntas"></i>平台价备注：</p>
					<div class="r"><input type="text" name="textfield" id="textfield" class="txt_f1" style="width:75%;" /></div>
				</div>
				...
				<div class="item_f"><p><i class="LGntas"></i>确认订单：</p>
					<div class="r">
						<select id="querendingdan" class="sel_f1" style="float:left;margin-right:8px;">
							<option value="1">确认完成</option>
                            <option value="finish">订单反馈</option>
							<option value="3">......</option>
						</select>
						<span class="info1_f" style="line-height:24px;">
