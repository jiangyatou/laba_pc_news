...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="index.php">首页</a><a href="admin_supplier_list.php">用户管理 </a><a href="admin_supplier_view.php" class="cur">会员详情 </a></div>
	</div>
...
<!--			</form>			-->
			...
			<div class="main_o clearfix" style="padding-bottom:0;width:90%;border:none;box-shadow: 0px 0px 0px #fff;">
				...
				<div class="clearfix">
					...
					<div class="item_f item_f_2" style="margin-top:20px; margin-left:-157px;">
