...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="index.php">首页</a><a href="admin_huser_list.php">用户管理 </a><a href="admin_huser_view.php" class="cur">会员详情 </a></div>
	</div>
	...
	<div class="main_o clearfix" style="padding-bottom:20px;">
		...
		<div class="safe_1 clearfix">
			...
			<div class="wrap_fr" style="width:47%;margin-right:2%;">
				...
				<!--	柱状图	-->
					<div class="tb_box3" id="tb_hv1"></div>
