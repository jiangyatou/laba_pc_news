...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="index.php">首页</a><a href="admin_shenqingfapiao_list.php">申请发票列表 </a><a href="admin_shenqingfapiao_view.php" class="cur">申请发票详情 </a></div>
	</div>
			...
			<div class="wrap_f clearfix" style="width:60%;">
				<form action="" method="post">
					...
					<div class="item_f" id="Email"><p><i class="LGntas"></i>邮箱地址：</p>
						<input type="text" name="textfield2" id="textfield2"  class="txt_f1" style="width:38%;"/>
					</div>
					<div class="item_f" id="dizhi"><p><i class="LGntas"></i>联系地址：</p>
						<input type="text" name="textfield2" id="textfield2"  class="txt_f1" style="width:75%;"/>
					</div>
					...
					<div class="item_f item_f_2" style="margin-top:30px; margin-left:-157px;">
						<div class="r"><input type="submit" value="确 认" class="sub5" style="amargin-left:15%;" /></div>
					</div>
				</form>
			</div>
