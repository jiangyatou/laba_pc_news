...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="putong_index.php">首页</a> <a href="car_list.php" class="cur">购物车</a></div>
	</div>
...
<table class="table_in1 cur table_ah" id="datatable1">
	...
	<tbody id="listcontent">
		...
		<div class="info3 clearfix">
			...
			<span class="sp2">已选定单： <i class="red" id="rows_order">1</i><i style="color:#ff0000">条</i></span>
		</div>
    ...
    <div class="pay_info">
        ...
        <form action="" method="post" id="form1">
            ...
            <div class="item">
                <button type="submit" class="sub" id="pay">结算</button>
            </div>
        </form>
    </div>
