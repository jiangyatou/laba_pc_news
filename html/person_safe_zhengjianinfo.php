	...
	<div class="main_s">
		...
		<div class="safe_2 clearfix">
					...
					<div class="WMain3 WMain3_2 clearfix"><p><i class="LGntas"></i>证件类型：</p>
						<select class="sel_2"  style="height: 45px; color: #666">
					...
					<div class="WMain3 WMain3_2 clearfix"><p><i class="LGntas"></i>上传证件副件：</p>
						<div class="img_up" id="img_up">
							...
							<div><input type="file" name="input_file" class="input_file" id="input_file" /><br/>
							<input type="text" class="path_file" id="path_file" readonly="readonly" /></div>
						</div>
					</div>
