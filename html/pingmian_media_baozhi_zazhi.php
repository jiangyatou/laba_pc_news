...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="putong_index.php">首页</a> <a href="pingmian_media_baozhi_zazhi.php"  class="cur">报纸杂志 </a></div>
	</div>
	
	<div class="main_o clearfix" style="">
	
		<h3 class="title5 clearfix"><strong>报纸杂志</strong></h3>
		
		<div class="Wikipedia">
		
			<div class="sbox_1 clearfix">
				<div class="sbox_1_w">
					<input type="hidden" name="_token" value="Bg2845QA7UW4nHJA8pz3cFB04U7mBag1xgNk2vhK">
                    <div class="sbox_1_item clearfix">
						<span class="l" data="option_0"><strong>投放形式：</strong></span>
						<div class="m">
							<ul category_id="0">
								<li><a href="">不限</a></li>
								<li data_id="1"><a href="">报纸</a></li>
								<li data_id="2"><a href="">杂志封面</a></li>
                            </ul>
						</div>
					</div>
					<div class="sbox_1_item clearfix">
						<span class="l" data="option_1"><strong>投放版面：</strong></span>
						<div class="m">
							<ul category_id="1">
								<li><a href="">不限</a></li>
								<li data_id=""><a href="">整版</a></li>
								<li data_id=""><a href="">一版</a></li>
								<li data_id=""><a href="">三版</a></li>
								<li data_id=""><a href="">四至十五版</a></li>
								<li data_id=""><a href="">封底</a></li>
								<li data_id=""><a href="">大众消费</a></li>
                            </ul>
						</div>
					...
					<div class="sbox_1_item clearfix">
						<span class="l" data="option_3"><strong>频道类型：</strong></span>
						<div class="m">
							<ul category_id="3">
								<li><a href="">不限</a></li>
					...
					<div class="sbox_1_item clearfix">
						<span class="l" data="option_4"><strong>制作工艺：</strong></span>
						<div class="m">
							<ul category_id="4">
								<li><a href="">不限</a></li>
								<li data_id=""><a href="">直面印刷</a></li>
							</ul>
						</div>
					</div>
					<div class="sbox_1_item clearfix">
						<span class="l" data="option_5" data2="radio"><strong>参考报价：</strong></span>
						<div class="m">
							<ul category_id="5">
								<li><a href="">不限</a></li>
			...
			<div class="sbox_3">
				...
				<div class="sbox_3_table tab1_body clearfix" style="margin-top:15px;">
					<table class="table_in1 cur" style="margin:0;">
						...
						<tbody id="wrapper_i">
							<tr rst_id="9">
								...
								<td >直面印刷直面印刷直面印刷直面印刷直面印刷直面印刷直面印刷直面印刷直面印刷直面印刷直面印刷直面印刷直面印刷直面印刷直面印刷直面印刷直面印刷直面印刷</td>
							</tr>
							<tr rst_id="17">
								<td class="logo-title"><img src="/images/logo_sina.png">新浪新闻</td>
								<td>报纸</td>
								...
								<li style="display:block;">
									...
									<div id="bianji" title="内部编辑" style="display: none;">
										<div class="WMain3 WMain3_1"><p><i class="LGntas">*</i>内容编辑：</p>
											<script id="container" name="content" type="text/plain" style="width:8%;height:300px;width:auto;"></script>
										</div>
									</div>															
...
//			url:'http://127.0.0.35:8080/Admin/media/release',
			url:'',
			url:'ajax_json_1.php',
			data: {
				'key':'media',
	...
	$(".sbox_1_item .m ul li a").click(function () {
		var option = $(this).closest(".m").prev("span").attr("data");
		var option2 = $(this).closest(".m").prev("span").attr("data2");	// data2 = radio 则为单选
		console.log(option);
		console.log(option2);
