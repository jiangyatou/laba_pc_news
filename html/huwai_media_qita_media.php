...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="putong_index.php">首页</a> <a href="huwai_media_qita_media.php"  class="cur">其他媒体 </a></div>
	</div>
	
	<div class="main_o clearfix" style="">
	
		<h3 class="title5 clearfix"><strong>其他媒体</strong></h3>
				...
				<div class="sbox_1_w">
                    ...
                    <div class="sbox_1_item clearfix">
						...
						<div class="m">
							<ul category_id="0">
								<li><a href="">全部</a></li>
								<li data_id="1"><a href="">刷墙广告</a></li>
								<li data_id="2"><a href="">墙贴广告</a></li>
								<li data_id="3"><a href="">其他</a></li>
                            </ul>
						</div>
					</div>
                    <div class="sbox_1_item clearfix">
