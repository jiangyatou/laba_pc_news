...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="putong_index.php">首页</a> <a href="person_edit.php">用户信息</a> <a href="person_safe.php" class="cur">安全设置</a></div>
	</div>
	...
	<div class="main_s">
		...
		<div class="safe_2 clearfix">
			...
			<div class="WMain3 WMain3_2 clearfix"><p><i class="LGntas"></i>邮箱验证码：</p>
				<input type="text" name="textfield" id="textfield" class="Bpass_ " style="margin-right: 10px;width:18%;">
				<input type="submit" name="button1" value="获取验证码" class="LGn3" style="cursor:pointer;height:45px;line-height:45px;">
			</div>
