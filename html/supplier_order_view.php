...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="supplier_index.php">首页</a> <a href="supplier_order_list.php">订单管理</a><a href="supplier_order_view.php" class="cur">订单详情</a></div>
	</div>
			...
			<form action="" method="post">
				...
				<div id="body_edit_type">
					...
					<div class="item_f" style="display:none;"><p><i class="LGntas"></i>文档导入：</p>
						<div class="r">
							<input type="text" name="doc_" id="name2_2"  class="txt_f1" style="width:75%;" readonly="">
...
<!--	质量反馈下的三项，当该订单状态选择“完成”下次再打开订单详情显示，	-->				
				<div class="item_f"><p><i class="LGntas"></i>质量反馈：</p>
					<div class="r"><input type="text" name="textfield" id="textfield" class="txt_f1" style="width:20%;" value="合格" /></div>
				</div>
