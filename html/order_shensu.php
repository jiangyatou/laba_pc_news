...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="putong_index.php">首页</a> <a href="order_list.php">订单管理</a><a href="order_shensu.php" class="cur">订单申诉</a></div>
	</div>
			...
			<form action="" method="post">
				...
				<div class="item_f"><p><i class="LGntas"></i>完成截图：</p>
					<div class="r" style="position:relative;">
						<img src="/images/img_up.jpg" id="img_upload" style="cursor:pointer;" />
