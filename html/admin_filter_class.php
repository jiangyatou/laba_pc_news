...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="index.php">首页</a><a href="admin_filter_class.php" class="cur">媒体筛选分类管理 </a></div>
	</div>
...
<div class="list_cm">
	<h3 class="h_list_cm"><strong>新闻约稿</strong></h3>
	<div class="m_list_cm">
		<div class="item_list_cm clearfix">
			<span class="sp1">网站类型：</span>
			<ul>
				<li><a href="">不限</a></li>
				<li><a href="">全国门户</a></li>
				<li><a href="">垂直行业</a></li>
		...
		<div class="item_list_cm clearfix">
			...
			<ul>
				...
				<li><a href="">都不带链接</a></li>
			</ul>
			<span class="sp2" title="按回车添加分类"><input type="text" value="" placeholder="分类名称 +" class="txt_cm" name="" /></span>
		</div>
		<div class="item_list_cm clearfix">
			<span class="sp1">收录参考：</span>
			<ul>
				<li><a href="">新闻源</a></li>
				<li><a href="">网页收录</a></li>
			</ul>
		...
		if(event.keyCode == 13){		//按回车
			...
			if( str == "" ){
				...
				if( flag == 1){
					...
					$(this).closest(".item_list_cm").find("ul").append(newli);
