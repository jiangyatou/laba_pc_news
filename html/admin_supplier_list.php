...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="index.php">首页</a><a href="admin_supplier_list.php" class="cur">用户管理 </a></div>
	</div>
...
-->
				<div style="float:right;">
					...
					<div class="l">
						<a class="sub4_2" href="#" style="background:#7db6eb">导出明细</a>
					</div>
				</div>
<!--
				</form>
