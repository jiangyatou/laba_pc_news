...
<div class="content"><div class="Invoice">
	...
	<div class="s1_tab">
		<ul class="clearfix">
			<li class="cur"><a href="supplier_order_list.php">订单管理</a></li>
	...
	<div class="place">
		<div class="place_ant"><a href="supplier_index.php">首页</a> <a href="supplier_order_list.php" class="cur">订单管理</a></div>
	</div>
...
//					url:"/Admin/searchnewspage",
					url:"data_supplier_order_list.php",
					dataType: 'html',
                    data:{
