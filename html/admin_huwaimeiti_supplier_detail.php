...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="index.php">首页</a><a href="admin_supplier_list.php">会员管理 </a><a href="admin_huwaimeiti_supplier_detail.php" class="cur">会员详情 </a></div>
	</div>
...
<!--			<form action="" method="post">			-->
					...
					<div class="item_f"><p><i class="LGntas"></i>媒体类型：</p>
						<div class="r">
							<select class="sel_f1" style="width:45%;">
					...
					<div class="item_f"><p><i class="LGntas"></i>代理价：</p>
						<div class="r">
							<input type="text" name="textfield" id="textfield" class="txt_f1" style="width:35%;"><span class="color1" style="color:#ff0000; font-size:20px; margin-left:10px;">元</span>
						</div>
					</div>
...
<!--			</form>			-->
			...
			<div class="main_o clearfix" style="padding-bottom:20px;width:90%;border:none;box-shadow: 0px 0px 0px #fff;">
			
				<div class="clearfix" style="padding-top:10px;">

					<div class="item_f"><p><i class="LGntas"></i>投放位置：</p>
						<div class="r"><input type="text" name="textfield" id="textfield" class="txt_f1" style="width:36%;"></div>
					</div>
					<div class="item_f"><p><i class="LGntas"></i>投放优势：</p>
						<div class="r">
							<textarea class="txt_ft1" style="width:70%;height:128px;"></textarea>
						</div>
					</div>

					<div class="item_f"><p><i class="LGntas"></i>投放基料：</p>
						<div class="r">
<ul class="ul_table clearfix" style="background:none">
	<li><span class="sp1">刊例价：</span>
		<span class="sp2"><input type="text" name="textfield" id="textfield" class="txt_f2"  value=""/></span>
	</li>
	<li><span class="sp1">刊例价备注：</span>
		<span class="sp2"><input type="text" name="textfield" id="textfield" class="txt_f2"  value="" /></span>
	</li>
	<li><span class="sp1">经营方式：</span>
		<span class="sp2"><input type="text" name="textfield" id="textfield" class="txt_f2"  value="" /></span>
	</li>
	<li><span class="sp1">媒体规格：</span>
		<span class="sp2"><input type="text" name="textfield" id="textfield" class="txt_f2"  value="" /></span>
	</li>
	<li><span class="sp1">画面形式：</span>
		<span class="sp2"><input type="text" name="textfield" id="textfield" class="txt_f2"  value="" /></span>
	</li>
	<li><span class="sp1">照明时间：</span>
		<span class="sp2"><input type="text" name="textfield" id="textfield" class="txt_f2"  value="" /></span>
	</li>
	<li><span class="sp1">媒体面积：</span>
		<span class="sp2"><input type="text" name="textfield" id="textfield" class="txt_f2"  value="" /></span>
	</li>
	<li><span class="sp1">投放档期：</span>
		<span class="sp2"><input type="text" name="textfield" id="textfield" class="txt_f2"  value="" /></span>
	</li>
	<li><span class="sp1">制作安装费：</span>
		<span class="sp2"><input type="text" name="textfield" id="textfield" class="txt_f2"  value="" /></span>
	</li>
	<li><span class="sp1">人流量：</span>
		<span class="sp2"><input type="text" name="textfield" id="textfield" class="txt_f2"  value="" /></span>
	</li>
	<li><span class="sp1">车流量：</span>
		<span class="sp2"><input type="text" name="textfield" id="textfield" class="txt_f2"  value="" /></span>
	</li>
	<li><span class="sp1">可发布行业：</span>
		<span class="sp2"><input type="text" name="textfield" id="textfield" class="txt_f2"  value="" /></span>
	</li>
</ul>
						</div>
					...
					<div class="sbox_1_item clearfix">
						...
						<div class="m">
							<ul class="sortable" category_id="2" set_name="Entrance_form">
								...
								<li data_id=""><a href="">机场内</a></li>
								<li data_id=""><a href="">机场广场</a></li>
								<li data_id=""><a href="">机场路</a></li>
					...
					<div class="sbox_1_item clearfix">
						...
						<div class="m">
							<ul class="sortable" category_id="4" set_name="channel">
								<li data_id="0"><a href="">全部</a></li>
								<li data_id=""><a href="">一周</a></li>
								<li data_id=""><a href="">一月</a></li>
								<li data_id=""><a href="">一季度</a></li>
								<li data_id=""><a href="">一年</a></li>
							</ul>
						</div>
					</div>
				...
				<div class="clearfix">
					...
					<div class="item_f"><p><i class="LGntas"></i>媒体简介：</p>
						<div class="r">
							<textarea class="txt_ft1" style="width:70%;height:120px;"></textarea>
						</div>
					</div>
					<div class="item_f"><p><i class="LGntas"></i>备注：</p>
						<div class="r">
							<textarea class="txt_ft1" style="width:70%;height:100px;"></textarea>
						</div>
					</div>
