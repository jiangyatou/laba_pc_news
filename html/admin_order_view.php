...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="index.php">首页</a><a href="admin_order_list.php">订单管理 </a><a href="admin_order_shensu.php" class="cur">订单详情 </a></div>
	</div>
			...
			<form action="" method="post">
				...
				<div id="body_edit_type">
					...
					<div class="item_f" style="display:none;"><p><i class="LGntas"></i>文档导入：</p>
						<div class="r">
							<input type="text" name="doc_" id="name2_2"  class="txt_f1" style="width:52%;" readonly="">
							<button type="button" name="upload_file" id="upload_file" class="txt7" style="">导入</button><br/>
						</div>
					</div>
