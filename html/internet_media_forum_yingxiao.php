...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="putong_index.php">首页</a> <a href="internet_media_forum_yingxiao.php"  class="cur">新闻约稿 </a></div> 
	</div>
	
	<div class="main_o clearfix" style="">
	
		<h3 class="title5 clearfix"><strong>论坛营销</strong></h3>
			...
			<div class="sbox_1 clearfix">
				<div class="sbox_1_w">
                    ...
                    <div class="sbox_1_item clearfix">
						<span class="l" data="option_0"><strong>发布类型：</strong></span>
						<div class="m">
							<ul category_id="0">
								<li><a href="">文字帖</a></li>
								<li data_id=""><a href="">图文帖</a></li>
                            </ul>
						</div>
					</div>
					<div class="sbox_1_item clearfix">
						<span class="l" data="option_1"><strong>指定效果：</strong></span>
						<div class="m">
							<ul category_id="1">
								<li><a href="">不限</a></li>
								<li data_id=""><a href="">帖子加精（周数）</a></li>
								<li data_id=""><a href="">帖子置顶（天数）</a></li>
								<li data_id=""><a href="">版主发帖</a></li>
                            </ul>
						</div>
					</div>
					<div class="sbox_1_item clearfix">
					...
					<div class="sbox_1_item clearfix">
						<span class="l" data="option_2"><strong>频道类型：</strong></span>
						<div class="m">
							<ul category_id="4">
								<li><a href="">不限</a></li>
					...
					<div class="sbox_1_item clearfix">
						<span class="l" data="option_3"><strong>阅读数：</strong></span>
						<div class="m">
							<ul category_id="5">
								<li><a href="">不限</a></li>
					...
					<div class="sbox_1_item clearfix">
						<span class="l" data="option_4"><strong>推荐套餐：</strong></span>
						<div class="m">
							<ul category_id="5">
								<li data_id=""><a href="">全网覆盖</a></li>
								<li data_id=""><a href="">行业覆盖</a></li>
								<li data_id=""><a href="">地方覆盖</a></li>
							</ul>
						</div>
					</div>
					<div class="sbox_1_item clearfix">
