...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="index.php">首页</a><a href="admin_shengqinggaojihuiyuan.php" class="cur">申请高级会员列表 </a></div>
	</div>
	
	<div class="main_o" style="padding-bottom:0;">
		
		<h3 class="title4"><strong><a href="#">申请高级会员列表</a></strong>
			<div class="search_1">
<!--
...
<table class="table_in1 cur" id="datatable1">
	...
	<tbody id="listcontent">
		<tr>
			...
			<td>1234565</td>
			<td class="color1">￥1452.00</td>
			<td>2152/条</td>
			<td>待审核</td>
			<td><a class="color2" href="admin_shenqinggaojihuiyuan_view.php">查看</a></td>
		</tr>
		<tr>
			<td>13711174990</td>
			<td>2017-4-25 11:12</td>
...
//					url:"/Admin/searchnewspage",
					url:"data_admin_shenqingfapiao_list.php",
					dataType: 'html',
                    data:{
