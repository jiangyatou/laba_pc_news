...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="index.php">首页</a><a href="admin_wenzhangguanli.php">文章管理 </a><a href="admin_wenzhangguanli_add.php" class="cur">添加文章 </a></div>
	</div>
		...
		<div class="clearfix wrap_f" style="padding:50px 10px 30px;width:70%;min-width:400px;">
			...
			<form action="" method="post">
				...
				<div class="item_f"><p><i class="LGntas"></i>来源：</p>
					<div class="r"><input type="text" name="textfield" id="textfield" class="txt_f1" style="min-width:155px;width:13%;" /></div>
				</div>
				...
				<div class="item_f"><p><i class="LGntas"></i>内容编辑：</p>
					<div class="r">
						<script id="editor" name="content" type="text/plain" style=" width:92%;min-height:300px;"></script>
					</div>
				</div>
