...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="index.php">首页</a><a href="admin_shenqingfapiao_list.php" class="cur">申请发票列表 </a></div>
	</div>
	
	<div class="main_o" style="padding-bottom:0;">
		
		<h3 class="title4"><strong><a href="#">申请发票列表</a></strong>
			<div class="search_1">
<!--
...
-->
				<div style="float:right;">
					...
					<div class="l">
						...
						<input name="submit" class="sub4_3" id="searchnews" value="查询" type="submit">
					</div>
				</div>
<!--
				</form>
