...
<div class="content"><div class="Invoice">
	...
	<div class="place">
		<div class="place_ant"><a href="putong_index.php">首页</a> <a href="internet_media_xinwen_yuegao.php"  class="cur">新闻约稿 </a></div>
	</div>
	
	<div class="main_o clearfix" style="">
	
		<h3 class="title5 clearfix"><strong>新闻约稿</strong></h3>
			...
			<div class="sbox_1 clearfix">
				<div class="sbox_1_w">
                    ...
                    <div class="sbox_1_item clearfix">
						<span class="l" data="option_0"><strong>网站类型：</strong></span>
						<div class="m">
							<ul category_id="0">
								<li><a href="" >不限</a></li>
								<li data_id="1"><a href="">全国门户</a></li>
								<li data_id="2"><a href="">垂直行业</a></li>
								<li data_id="3"><a href="">地方门户</a></li>
                            </ul>
						</div>
					</div>
                    <div class="sbox_1_item clearfix">
						<span class="l" data="option_1"><strong>入口形式：</strong></span>
						<div class="m">
							<ul category_id="1">
								<li><a href="" >不限</a></li>
								<li data_id=""><a href="">文字标题</a></li>
								<li data_id=""><a href="">焦点图片</a></li>
								<li data_id=""><a href="">图文混排</a></li>
								<li data_id=""><a href="">其他图片</a></li>
								<li data_id=""><a href="">通栏</a></li>
								<li data_id=""><a href="">文字链</a></li>
								<li data_id=""><a href="">画中画</a></li>
								<li data_id=""><a href="">Banner</a></li>
								<li data_id=""><a href="">Buttom</a></li>
								<li data_id=""><a href="">Floating</a></li>
								<li data_id=""><a href="">流媒体</a></li>
								<li data_id=""><a href="">视频</a></li>
								<li data_id=""><a href="">全屏广告</a></li>
                            </ul>
						</div>
					</div>
                    <div class="sbox_1_item clearfix">
						...
						<div class="m">
							<ul category_id="2">
								<li><a href="">不限</a></li>
								<li data_id=""><a href="">网站首页</a></li>
								<li data_id=""><a href="">频道首页</a></li>
								<li data_id=""><a href="">二级频道首页</a></li>
								<li data_id=""><a href="">三级频道首页</a></li>
								<li data_id=""><a href="">列表页入口</a></li>
								<li data_id=""><a href="">无入口</a></li>
                            </ul>
						</div>
					</div>
					<div class="sbox_1_item clearfix">
					...
					<div class="sbox_1_item clearfix">
						<span class="l" data="option_4"><strong>频道类型：</strong></span>
						<div class="m">
							<ul category_id="4">
								<li><a href="">不限</a></li>
								<li data_id=""><a href="">新闻财经</a></li>
								<li data_id=""><a href="">IT科技</a></li>
								<li data_id=""><a href="">娱乐</a></li>
								<li data_id=""><a href="">旅游</a></li>
								<li data_id=""><a href="">教育</a></li>
								<li data_id=""><a href="">房产</a></li>
								<li data_id=""><a href="">家居</a></li>
								<li data_id=""><a href="">汽车</a></li>
								<li data_id=""><a href="">女性</a></li>
								<li data_id=""><a href="">时尚</a></li>
								<li data_id=""><a href="">美容</a></li>
								<li data_id=""><a href="">母婴育儿</a></li>
								<li data_id=""><a href="">健康</a></li>
								<li data_id=""><a href="">艺术家</a></li>
								<li data_id=""><a href="">电数码</a></li>
								<li data_id=""><a href="">游戏动漫</a></li>
								<li data_id=""><a href="">体育</a></li>
								<li data_id=""><a href="">资讯商讯</a></li>
								<li data_id=""><a href="">生活</a></li>
								<li data_id=""><a href=""> 食品</a></li>
								<li data_id=""><a href="">文化</a></li>
								<li data_id=""><a href="">环保</a></li>
								<li data_id=""><a href="">公益</a></li>
								<li data_id=""><a href="">法律</a></li>
								<li data_id=""><a href="">地方</a></li>
                            </ul>
						</div>
						<span class="r"><a href="">更多</a></span>
					</div>
					<div class="sbox_1_item clearfix">
						<span class="l" data="option_6"><strong>正文链接：</strong></span>
						<div class="m">
							<ul category_id="6">
								<li><a href="">不限</a></li>
								<li data_id=""><a href="">超链</a></li>
								<li data_id=""><a href="">网址</a></li>
								<li data_id=""><a href="">图片</a></li>
								<li data_id=""><a href="">二维码</a></li>
								<li data_id=""><a href="">联系方式</a></li>
								<li data_id=""><a href="">微信公众号</a></li>
								<li data_id=""><a href="">都不带链接</a></li>
							</ul>
						</div>
					</div>
					<div class="sbox_1_item clearfix">
						<span class="l" data="option_7"><strong>收录参考：</strong></span>
						<div class="m">
							<ul category_id="7">
								<li><a href="">不限</a></li>
								<li data_id=""><a href="">新闻源</a></li>
								<li data_id=""><a href="">网页收录</a></li>
							</ul>
						</div>
					</div>
					<div class="sbox_1_item clearfix">
						...
						<div class="m">
							<ul category_id="5">
								<li><a href="">不限</a></li>
								<li data_id=""><a href="">50元以下</a></li>
								<li data_id=""><a href="">50-100元</a></li>
								<li data_id=""><a href="">100-200元</a></li>
								<li data_id=""><a href="">200-500元</a></li>
								<li data_id=""><a href="">500-1000元</a></li>
								<li data_id=""><a href="">1000元以上</a></li>
							</ul>
						</div>
					</div>
				</div>
